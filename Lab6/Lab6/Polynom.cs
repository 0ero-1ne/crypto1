namespace Lab6
{
    class Polynom
    {
        ...
        public Polynom(int degree, bool plusOne = false) // Constructor 3: degree
        {
            this.degree = degree;
            this.bites = new List<int>();
        ...
        {
            this.bites = RemoveLeadingZeroes(bites);
            this.degree = bites.Count - 1;
        } // Constructor 4: bites

        public Polynom(string bites) // Constructor 5: string of bites
        {
            this.bites = new List<int>();
            ...
            this.degree = this.bites.Count - 1;
        }
